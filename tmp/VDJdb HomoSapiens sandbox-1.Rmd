...
info_from_matrices <- function(inpname) {
folder = "seqdata/HomoSapiens/occurencematrices/"
#folder = ""
inpname = inpname

df <- read.csv(paste(folder, "msubstitution_matrix_out_teach_", inpname, ".csv", sep =""), stringsAsFactors = F) 
df <- melt(df)
df$type <- "outer"
df.1 <- read.csv(paste(folder, "substitution_matrix_out_teach_", inpname, ".csv", sep =""), stringsAsFactors = F) 
df.1 <- melt(df.1)
...
```{r}
info_from_matrices("1_0_0_1")
info_from_matrices("2_0_0_2")
info_from_matrices("3_0_0_3")
info_from_matrices("4_0_0_4")
info_from_matrices("5_0_0_5")
info_from_matrices("6_0_0_6")
```
...
def getdistances(inppath, outpath, pdbs_imposed, pdbs, chainname='B', cdrname='CDR3'):
    pdb_parser = Bio.PDB.PDBParser(QUIET = True)
    try:
        with open(outpath, 'w') as out:
            out.write('pdb1\tpdb2\tpdb1_AA\tpdb2_AA\tdistance\tCDR_type\tCDR_chain\tAA1\tAA2\t#1\t#2\tpdb1seq\tpdb2seq\n')

...
if myargs.input_dir is None:
    myargs.input_dir = '../seqdata/HomoSapiens/distances/distances_from_pdb_BCDR3.txt'
if myargs.output_dir is None:
    myargs.output_dir = '../seqdata/HomoSapiens/distances/pairwise_alignments_BCDR3.txt'
